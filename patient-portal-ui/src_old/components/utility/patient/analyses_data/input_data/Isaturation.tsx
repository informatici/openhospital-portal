...
class Isaturation extends Component<IsaturationProps, IsaturationState> {
    ...
    render() {
        ...
        if (this.state.io_vis == "output") {
            return (
                ...
                // alignItems="center"
                >
                    <Typography variant="body1" display="inline" sx={{ width: 0.3 }}>Saturation: </Typography>
