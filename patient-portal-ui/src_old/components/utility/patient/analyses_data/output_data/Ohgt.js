            ...
            <div>
                <Accordion sx={{ width: 1, mt: 1 }} >
                    ...
                    >
                        ...
                        <Typography variant="body1" display="inline" sx={{ padding: 0 }}>Last HGT: 2023/03/25</Typography>
                        <Typography variant="body1" sx={{ fontWeight: 'bold', ml: 1, padding: 0 }} display="inline">87 mg/dl</Typography>
