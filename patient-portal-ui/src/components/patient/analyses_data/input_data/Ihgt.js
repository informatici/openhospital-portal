        ...
        if (this.state.io_vis == "output") {
            return (
                <Box sx={{ height: 60, width: 1, mt: 1.5 }}
                    ...
                    alignItems="center"
                >
                    <Typography variant="body1" display="inline" sx={{ width: 0.3 }}>Hgt: </Typography>
                    <Typography variant="body1" sx={{ fontWeight: 'bold', width: 0.3, }} display="inline">{this.state.getvalue} mg/dl</Typography>
