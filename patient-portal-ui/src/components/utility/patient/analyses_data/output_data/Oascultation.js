...
class Oascultation extends Component {
    render() {
        return (
            <div>
                 <Accordion sx={{ width: 1, mt:1 }} >
                    ...
                    >
                        ...
                        <Typography variant="body1" display="inline" sx={{ padding: 0 }}>Last Ascultation: 2023/03/31</Typography>
                        <Typography variant="body1" sx={{ fontWeight: 'bold', ml: 1 ,padding: 0 }} display="inline">134</Typography>
