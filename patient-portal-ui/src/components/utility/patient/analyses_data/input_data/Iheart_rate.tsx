...
export default function Iheart_rate(props: {
  dataDef: Iheart_rateProps;
  edit?: boolean
  delete?: boolean
}) {
  ...
  const handleSubmit = (event: {
    ...
    let inputValue = event.target.heart_rate.value;
    if (inputValue == null) {
      setDataError(true);
    ...
    <>
      ...
      <form onSubmit={handleSubmit} id='my-form'>
        <Box display="flex"
          ...
          alignItems="center"> <Box component="img" src="/static/measure_patient/Hearth Rate.png" alt="logo" /></Box>
