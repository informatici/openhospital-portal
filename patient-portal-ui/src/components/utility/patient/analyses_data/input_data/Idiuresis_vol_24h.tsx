...
export default function Idiuresis_vol_24h(props: {
  dataDef: Idiuresis_vol_24hProps;
  edit?: boolean
  delete?: boolean
}) {
  ...
  const handleSubmit = (event: {
    ...
    let inputValue = event.target.diuresis_vol_24h.value;
    if (inputValue == null) {
      setDataError(true);
      ...
      if (dataDisabled == false) {
        ...
        let patientId = localStorage.getItem("IdPatient");
        let value1 = event.target.diuresis_vol_24h.value;
    ...
    <>
      ...
      <form onSubmit={handleSubmit} id='my-form'>
        <Box display="flex"
          ...
          alignItems="center"> <Box component="img" src="/static/measure_patient/Diuresis Vol.png" alt="logo" /></Box>
