...
interface Irespiration_rateState {
    io_vis?: string;
    getvalue?: string;
    disAddIcon?: boolean;
...
class Irespiration_rate extends Component<Irespiration_rateProps, Irespiration_rateState> {
    ...
    render() {
        ...
        if (this.state.io_vis == "output") {
            return (
                ...
                // alignItems="center"
                >
                    <Typography variant="body1" display="inline" sx={{ width: 0.3 }}>Respiration_rate: </Typography>
