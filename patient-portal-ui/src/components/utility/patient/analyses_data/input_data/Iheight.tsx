...
export default function Iheight(props: {
  dataDef: IheightProps;
  edit?: boolean
  delete?: boolean
}) {
  ...
  const handleSubmit = (event: {
    ...
    let inputValue = event.target.height.value;
    if (inputValue == null) {
      setDataError(true);
    ...
    <>
      ...
      <form onSubmit={handleSubmit} id='my-form'>
        <Box display="flex"
          ...
          alignItems="center"> <Box component="img" src="/static/measure_patient/Height.png" alt="logo" /></Box>
