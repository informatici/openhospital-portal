...
const url_0 = 'http://develop.ohpp.local:18080/api/';
const url_1 = 'http://develop.ohpp.local:18080/api/';
...
export const DeafutlAllData = {
  ...
  getAllUsers: async function () {
    let response = await fetch('http://develop.ohpp.local:18080/api/admin/users');
